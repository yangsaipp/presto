        ...
        implements PlanOptimizer
{
    ...
    private static class LimitContext
    {
        ...
        public LimitContext(long count, long offset, boolean partial)
        {
            this.count = count;
            ...
            extends SimplePlanRewriter<LimitContext>
    {
        ...
        public PlanNode visitLimit(LimitNode node, RewriteContext<LimitContext> context)
        {
            ...
            return context.rewrite(node.getSource(), new LimitContext(count, node.getOffset(),false));
        }
        ...
        public PlanNode visitAggregation(AggregationNode node, RewriteContext<LimitContext> context)
        {
            ...
            if (limit != null &&
                ...
                return new DistinctLimitNode(idAllocator.getNextId(), rewrittenSource, limit.getCount(),limit.getOffset(), false, rewrittenSource.getOutputVariables(), Optional.empty());
            }
            PlanNode rewrittenNode = context.defaultRewrite(node);
            if (limit != null) {
        ...
        public PlanNode visitUnion(UnionNode node, RewriteContext<LimitContext> context)
        {
            ...
            if (limit != null) {
                childLimit = new LimitContext(limit.getCount(), limit.getOffset(),true);
            }
            ...
            if (limit != null) {
                output = new LimitNode(idAllocator.getNextId(), output, limit.getCount(), limit.getOffset() ,limit.isPartial());
            }
            return output;
        }
